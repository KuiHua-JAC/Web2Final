    ...
    try{
        ...
        if(collectionArray[0]=="cars" && resetFlag){
          ...
          if(collectionArray.length == 0 || resetFlag){
             ...
             await db.createCollection("cars", {collation: {locale: "en", strength: 1}});
...
module.exports={initialize,addCar,getSingleCar,getAllCars,deleteSingleCar,updateCarMake,updateCarModel,updateCarYear}
